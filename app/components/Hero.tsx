...
const Hero = () => {
  return (
    <>
              ...
              <ScrollAnimationContainer>
                <motion.div variants={scrollAnimation}>
                  ...
                  <p className="mb-10 font-medium text-justify leading-relaxed mt-2">
                    ...
                    jadwal pembelajaran yang fleksibel, cocok bagi Anda yang
                    ingin tetap bekerja sambil belajar. Bergabunglah dan
                    wujudkan masa depan lebih cerah bersama kami!
                  </p>
      ...
      <div className="px-4">
        <Image
          src="/heroimg/PPDB.jpeg"
          alt="PPDB"
          width={724}
          height={1024}
          className="relative rounded-lg shadow-lg max-w-full mx-auto mt-36"
        />
      </div>
    </>
  );
